       ...
       Nutrition = (EditText) findViewById(R.id.nutrition);
            ...
            public void onClick(View v) {
                ...
                if (counter <= 2) {
                    ...
                    try {
                        ...
                        //new File(Environment.getExternalStorageDirectory().getAbsolutePath()+ "Photos");
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String nutrition1 = Nutrition.getText().toString().trim();
                //Checking if all the values are not empty
                if (TextUtils.isEmpty(Location1) ||  TextUtils.isEmpty(Description1) || (TextUtils.isEmpty(Image))
                        || TextUtils.isEmpty(nutrition1) || TextUtils.isEmpty(ContactNumber1) || TextUtils.isEmpty(Name1) ) {
                    ...
                    CollectionReference records = db.collection("Searches");

                    Record record = new Record(ContactNumber1, Description1, Image,Image, Location1, Name1, nutrition1);
